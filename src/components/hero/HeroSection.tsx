      ...
      <div className="hero-content hero-split">
        <div className="hero-left">
          ...
          <p className="hero-desc">
            Building enterprise web applications with React, Next.js &amp; Angular
            at <span className="hl">Skillmine Technology Consulting</span>.
          </p>
          ...
          <div className="hero-socials">
            ...
            <a href="mailto:nanthininanthini708@gmail.com" className="social-link" aria-label="Email">
